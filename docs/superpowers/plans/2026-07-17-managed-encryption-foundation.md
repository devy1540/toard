...
- Produces `encryptManagedContent(input, uck, installationId, userId, keyVersion): ManagedEncryptedContent`.
- Produces `decryptManagedContent(row, uck, installationId, userId): string`.
