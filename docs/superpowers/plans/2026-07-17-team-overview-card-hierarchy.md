    ...
    <section className="border-border/80 bg-card rounded-xl border px-5 py-5">
      <div className="flex flex-wrap items-end justify-between gap-6">
        <div className="min-w-0">
          ...
          <div className="mt-2 text-4xl font-semibold tracking-tight tabular-nums">{totalCost}</div>
...
```tsx
<TeamRankingHero
  totalCost={formatCostForCoverage(fmtUsd(rankedCost), coverage, costLabels)}
